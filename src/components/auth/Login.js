        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            <form onSubmit={handleSendOtp} className="space-y-4">
              <label className="text-xs font-black uppercase text-gray-400 px-2 tracking-widest">Ingresar con Celular</label>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm"><span className="px-2 bg-white dark:bg-gray-900 text-gray-400">Otras formas de entrar</span></div>
            </div>
